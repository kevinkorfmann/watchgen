"""
Tests for the watchgen.mini_smcpp module.

All functions are imported from watchgen.mini_smcpp rather than redefined.
Tests cover mathematical properties and expected behaviors of the SMC++
...
from watchgen.mini_smcpp import (
    ...
    undistinguished_coalescence_rate,
    distinguished_coalescence_rate,
    emission_unphased,
    compute_h,
    build_rate_matrix,
    solve_ode_piecewise,
    compute_h_values,
    eigendecompose_rate_matrix,
    fast_matrix_exp,
